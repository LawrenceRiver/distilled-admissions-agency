...
| 官网 PDF 存证 | 原版 PDF、增强版 PDF、HTML、网页原文、PDF 文本、校验 JSON |
| Requirement Audit | 截止日期、GPA、语言、GRE、先修课、作品集、writing sample、课程关键词 |
| 公开案例挖掘 | GradCafe、Yocket、Reddit、知乎、小红书、论坛、博客、中介案例 |
| 学校路线卡 | 项目偏好、硬门槛、软实力包容度、叙事钩子、风险点 |
| 冲主保矩阵 | 每个项目的 band、硬分风险、软实力补偿、证据强度、下一步动作 |
| 爬虫/OCR 后端 | Firecrawl、Playwright、小红书链接解析、MediaCrawler 风格研究、图片 OCR |
